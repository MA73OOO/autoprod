...
| **FEAT-04** | **Video Studio & Timeline Pro (con Looper Express Integrado)** | FastAPI / FFmpeg / Moviepy | [Ficha Técnica](docs/features/video_looper/ficha_tecnica.md) \| [Idea & Escalabilidad](docs/features/video_looper/idea.md) |
