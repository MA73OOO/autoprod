...
export const PLANS_CONFIG: Record<'FREE' | 'STARTER' | 'PRO' | 'ENTERPRISE', PlanConfig> = {
  FREE: {
    ...
    features: [
      ...
      '1 Canal de YouTube gestionado',
      'Orquestador gpt-4o-mini (1 crédito por acción de prueba)',
  ...
  STARTER: {
    ...
    features: [
      'Orquestador gpt-4o-mini 100% ILIMITADO y GRATIS',
      'Bolsa mensual de 1,800 créditos de IA para modelos pesados',
      'Hasta 3 Canales de YouTube simultáneos',
  ...
  PRO: {
    ...
    features: [
      'Orquestador gpt-4o-mini 100% ILIMITADO y GRATIS',
      'Bolsa mensual de 2,700 créditos de IA para modelos pesados',
      'Hasta 10 Canales de YouTube simultáneos',
  ...
  ENTERPRISE: {
    ...
    features: [
      'Orquestador gpt-4o-mini 100% ILIMITADO y GRATIS',
      'Bolsa mensual de 4,500 créditos de IA para modelos pesados',
      'Canales de YouTube ILIMITADOS',
      'Video Looper 4K 60fps sin compresión + Pre-render background',
      'Whisper Studio masivo ilimitado local + 500 min Cloud',
      'Agentes autónomos continuos + Prompts VIP personalizados',
